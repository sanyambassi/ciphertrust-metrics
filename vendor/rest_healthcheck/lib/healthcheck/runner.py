...
from .checks.groups import check_groups
from .checks.interfaces import (
    check_interfaces,
    check_log_forwarders,
    check_notifications,
)
from .checks.properties import check_properties
...
def run(
    ...
    check_properties(ctx, client, cm_version=cm_version)
    check_groups(ctx, client)
